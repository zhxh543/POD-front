  ...
  <div id="uncoilImportData">
    <div  class="el_content">
      ...
      <div class="handle-block">
        ...
        <a :href="downloadUrl+'/importTemplate/OpenBook.xlsx'" download class="el-button  el-button--primary ">下载模板</a>
      </div>
      <template>
        <el-table
          :data="tableData"
...
<script>
  export default {
    name: "uncoilImportData",
    data (){
      return {
        msg : "开卷数据导入",
        crumbsList:[   //  面包屑
          {name:'开卷数据导入',url:{routerName:'importManage',params:{name:'uncoilImportManage'}}},
        ],
        //列表
        tableData: [],//data
        page : 1,//当前页数
