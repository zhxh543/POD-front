  ...
  <div id="internetShop">
    <div  class="el_content">
      ...
      <div class="handle-block">
        ...
        <a :href="downloadUrl+'/importTemplate/NetShop.xlsx'" download class="el-button  el-button--primary ">下载模板</a>
      </div>
      <template>
        <el-table
          :data="tableData"
          ...
          <el-table-column
            prop="dealerId"
            fixed="left"  width="130px"
            label="网店编号" show-overflow-tooltip>
          </el-table-column>
          <el-table-column
            prop="isbn"
      ...
      <p class="rds-remark" v-html="importIntDesc"></p>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    data (){
      return {
        msg : "网店数据导入",
        crumbsList:[   //  面包屑
          {name:'网店数据导入',url:{routerName:'importManage',params:{name:'internetShopManage'}}},
        ],
        //列表
        tableData: [],//data
        page : 1,//当前页数
