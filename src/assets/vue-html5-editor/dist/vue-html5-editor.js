    ...
    methods: {
        ...
        uploadToServer: function uploadToServer(file) {
            ...
            xhr.onerror = function () {
                ...
                this$1.setUploadError(xhr.response.msg);
            };
    ...
    switch (command) {
        ...
        case Command.JUSTIFY_LEFT: {
          ...
          textNodes$1.forEach(function (textNode) {
            ...
            if(parentBlock){
              if(parentBlock.className === 'content'){
